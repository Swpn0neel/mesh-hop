...
- Windows installer (NSIS): [`MeshHop_0.2.9_x64-setup.exe`](release/MeshHop_0.2.9_x64-setup.exe)
- Windows MSI (managed/silent deploy): [`MeshHop_0.2.9_x64_en-US.msi`](release/MeshHop_0.2.9_x64_en-US.msi)
